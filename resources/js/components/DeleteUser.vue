...
<template>
    <div class="space-y-6">
        <HeadingSmall title="Eliminar cuenta" description="Eliminá tu cuenta y todos sus datos" />
                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Una vez que elimines tu cuenta, todos sus datos y recursos se borrarán de forma permanente. Ingresá tu
                                contraseña para confirmar que querés eliminar tu cuenta de forma definitiva.
                            </DialogDescription>
                        </DialogHeader>
