...
<template>
    <AuthBase title="Creá tu cuenta" description="Completá tus datos para crear la cuenta">
        <Head title="Registro" />
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            ...
            <div class="text-center text-sm text-muted-foreground">
                ¿Ya tenés una cuenta?
                <TextLink :href="route('login')" class="underline underline-offset-4" tabindex="6">Iniciá sesión</TextLink>
            </div>
        </form>
    </AuthBase>
</template>
